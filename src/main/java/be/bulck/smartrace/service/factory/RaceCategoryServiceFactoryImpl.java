...
/**
 * A class representing an implementation of a factory to retrieve the race category service.
 *
 * @author Fabien Vanden Bulck
 */
public class RaceCategoryServiceFactoryImpl extends RaceCategoryServiceFactory {
